...
# Класс главного окна, на котором будут располагаться кнопки и таблица
...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        button_refresh = tk.Button(toolbar, bg='#d7d8e0', bd=0, image=self.refresh_img, command=self.open_search_dialogue)
    ...
    # Метод связи дочернего окна с кнопклй изменения контакта
    ...
    # Метод записи поиска контактов по имени
...
class Search(tk.Toplevel):
    ...
    def __init__(self):
        ...
        # Метод добавления интерфейска на окно поиска (кнопки, строка для поиска)
    ...
    def init_search(self):
        ...
        # Кнопка, запрограммированная на закрытие окна поиска

        btn_cancel = ttk.Button(self, text='Закрыть', command=self.destroy)
        btn_cancel.place(x=185, y=50)

        # Кнопка, запрограммированная на запуск поиска по имени
        ...
        # Программирование автоматического закрытия окна поиска после исполнения того же поиска
...
class Child(tk.Toplevel):
    ...
    # Метод добавления интерфейса на окно поиска (Кнопки, строки для вписания данных)
...
class Update(Child):
    ...
    # Метод добавления интерфейса на окно изменений (Кнопки, строк для изменения данных)
